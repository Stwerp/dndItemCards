...
\begin{tikzpicture}
    ...
    \foreach \filename in \cardfiles {%
        ...
        % Draw the card
        \node[minimum width=\cardwidth, minimum height=\cardheight, draw, rectangle, fill=white, scale=1] at  ({\j * (\cardwidth + 0.12in)}, {-\i * (\cardheight + 0.02in)}) { \fontsize{6}{7}\selectfont
